...
function wpa_add_honeypot_field(){
	...
	var allFormSelectors = [
	    ...
	    '.site-block-toolset-cred-form form',    // Toolset Forms
	    ...
	    'form.user-registration-form-login',   // User Registration & Membership for het oude systeem

	    'form#lostpasswordform',			   // Lost Password Form
	    'form.lost_reset_password',            // Tutor Password Form
	    'form.ur_lost_reset_password',    	   // User Registration & Membership for het oude systeem	    

	    
	    //Registration Forms
	    'form.register',            		   // User Registration & Membership for het oude systeem
